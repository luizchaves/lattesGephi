...
# for (year in 1960:2013) {
  ...
  path <- "~/Documents/code/github/lucachaves/lattesGephi/src/flow-edges/gephi/data/edges-flow-city-all/"
  file_map <- paste(path,"img-map-", theme, "-normal/map-",year,".png", sep="")
  file_data <- paste(path,"data-latlon/lattes-flows-city-all-", year,".csv", sep="")
