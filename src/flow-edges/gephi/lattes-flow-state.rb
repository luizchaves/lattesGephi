...
csv_string = CSV.generate(:col_sep => ",") do |csv|
	...
	places.each{|index,place|
		csv << [place[:id],place[:state],place[:class],place[:city],place[:state],place[:country],place[:latitude],place[:longitude]]
	}
end
File.write("nodes-flow-state.csv", csv_string)
...
File.write("edges-flow-state.csv", csv_string)
